...
#     # create an initial state the graph expects
#     state = ResearcherState(
#         messages=[HumanMessage(content="Research topic: climate change impact on agriculture")]
#     )

#     # invoke the compiled graph with the state instance (async entrypoint for async nodes)
#     # use the async API so async node functions (like `researcher`) are supported
